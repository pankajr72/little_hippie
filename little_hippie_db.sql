...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 25, 2020 at 08:34 AM
...
(4, '2020_10_09_073153_create_product_categories_table', 1),
(5, '2020_10_09_073216_create_products_table', 1),
(6, '2020_10_09_073823_create_product_images_table', 1),
(7, '2020_10_17_091324_create_recommends_table', 1),
(8, '2020_10_17_092142_create_wishlists_table', 1),
(9, '2020_10_17_092336_create_addresses_table', 1),
(10, '2020_10_17_092354_create_orders_table', 1),
(11, '2020_10_17_092422_create_ordered_products_table', 1);
...
(1, 'Test', 'test@example.com', NULL, '$2y$10$JUPo9iaCAt4VKaWY2nSHVeyDvxcrFUHjRBO5aBpGQS12m4cNdL/JK', NULL, '2020-10-25 02:02:01', '2020-10-25 02:02:01');
...
ALTER TABLE `recommends`
  ADD PRIMARY KEY (`id`),
  ADD KEY `recommends_user_id_foreign` (`user_id`),
  ADD KEY `recommends_product_id_foreign` (`product_id`);
...
--
ALTER TABLE `recommends`
  ADD CONSTRAINT `recommends_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`),
  ADD CONSTRAINT `recommends_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
